# ensure_qwen_128k.ps1 — 拉起本地 Qwen3.6-35B (128K 超长上下文档)
# 用法: powershell -ExecutionPolicy Bypass -File <HOME>\ensure_qwen_128k.ps1
# 128K 最优档: ncmoe=20 + q8 KV (2026-08-11 实测 55.3 tok/s decode)
# 悬崖规律: ctx 越大悬崖 ncmoe 越上移 (32K→16, 64K→17, 128K→20)
# 日常压缩用 64K 档 (60.7 更快); 128K 仅超长输入时用
$ErrorActionPreference = "Continue"

$ROOT   = "<YOUR_LLAMA_CPP_DIR>"
$MODEL  = "<YOUR_MODEL_PATH>"
$LOG    = "$ROOT\qwen_apex_128k.log"
$PORT   = 8080
