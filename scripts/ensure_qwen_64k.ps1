# ensure_qwen_64k.ps1 — 拉起本地 Qwen3.6-35B (64K compression 专用档)
# 用法: powershell -ExecutionPolicy Bypass -File <HOME>\ensure_qwen_64k.ps1
# 64K 最优档: ncmoe=17 + q8 KV (2026-08-11 实测 60.7 tok/s decode / 252 tok/s prefill)
# 满足 Hermes 压缩辅助模型 64K 硬门槛；质量无损 (q8 KV)
# 32K 轻量档用 ensure_qwen.ps1
$ErrorActionPreference = "Continue"

$ROOT   = "<YOUR_LLAMA_CPP_DIR>"
$MODEL  = "<YOUR_MODEL_PATH>"
$LOG    = "$ROOT\qwen_apex_64k.log"
$PORT   = 8080
